...
const mastoDB = require("nano")("http://admin:password@172.26.132.178:5984");
const app = express();
...
const couchdbMA = mastoDB.db.use("mastodon_rename_test");
...
app.get("/line", async (req, res) => {
  ...
  console.log("bodyMA ", bodyMA.total_rows);
  const countmapMA = new Map();
  bodyMA.rows.map(doc => {
    console.log("doc ", doc);
    const { key, value } = doc;

    if (countmapMA.has(key)&&key!="null") {
      // If it exists, increment the count by 1
  ...
  const maObj = {
    id: "Mastodon",
    data: Array.from(countmapMA.entries()).map(([key, value]) => ({ x: key, y: value }))
  }
...
app.get("/line2_1", async (req, res) => {
  ...
  // const bodyStock = await couchdb.view('language', 'language');
  // console.log("bodyStock ", bodyStock.total_rows);
  // const countMapStock = new Map();
  // bodyStock.rows.map(doc => {
  //   console.log("doc ", doc);
  //   const { key, value } = doc;

  //   if (countMapStock.has(key)) {
  //     // If it exists, increment the count by 1
  //     const count = countMapStock.get(key);
  //     countMapStock.set(key, count + 1);
  //   } else {
  //     // If it doesn't exist, initialize the count to 1
  //     countMapStock.set(key, value);
  //   }
  // }); 
  ...
  // const bodyStock = await couchdbMA.view('language', 'language');
  // console.log("bodyStock ", bodyStock)
  // const dataSt = bodyStock.rows.map(doc => doc.key);
...
app.get("/line2_2", async (req, res) => {
  ...
  // const bodyBit = await couchdb.view('language', 'language');
  // console.log("bodyBit ", bodyBit.total_rows);
  // const countMapBit = new Map();
  // bodyBit.rows.map(doc => {
  //   console.log("doc ", doc);
  //   const { key, value } = doc;

  //   if (countMapBit.has(key)) {
  //     // If it exists, increment the count by 1
  //     const count = countMapBit.get(key);
  //     countMapBit.set(key, count + 1);
  //   } else {
  //     // If it doesn't exist, initialize the count to 1
  //     countMapBit.set(key, value);
  //   }
  // }); 
